  ...
  actions: {
    async initialize(context) {
      const result = await axios.get(
        "https://todoapp-laravel-sakin.herokuapp.com/api/todos"
      );
    ...
    async addTodo(context, payload) {
      const result = await axios.post(
        "https://todoapp-laravel-sakin.herokuapp.com/api/todos/create",
        {
          title: payload.title,
        }
      );
    ...
    async editTodo(context, payload) {
      const result = await axios.post(
        "https://todoapp-laravel-sakin.herokuapp.com/api/todos/update",
        {
          id: payload.id,
          title: payload.title,
        }
    ...
    async toggleComplete(_, payload) {
      // DBの完了、未完了ステータスを変更
      await axios.post(
        "https://todoapp-laravel-sakin.herokuapp.com/api/todos/complete",
        {
          id: payload.id,
        }
      );
